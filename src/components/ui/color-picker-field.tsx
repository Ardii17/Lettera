...
export function ColorPickerField({
  ...
  return (
    <div className={cn("space-y-3", className)}>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 rounded-xl border border-seal-100 bg-seal-50/70 p-3">
        {/* Native picker trigger button */}
        <button
          type="button"
          onClick={() => nativeColorInputRef.current?.click()}
          className="inline-flex items-center justify-center gap-2 rounded-lg border border-seal-200 bg-white px-3.5 py-2 text-xs font-semibold text-seal-800 shadow-xs transition-colors hover:bg-seal-50 shrink-0"
        >
          <span
          ...
          <span className="whitespace-nowrap">Buka Color Spectrum Wheel</span>
        </button>

        <div className="flex flex-wrap items-center justify-between sm:justify-end gap-2.5">
          {/* Hex input */}
          <div className="flex items-center gap-1.5 text-xs">
            <span className="font-semibold text-ink-muted shrink-0">HEX:</span>
            <input
              type="text"
              value={currentColor}
              ...
              maxLength={7}
              placeholder="#c03a52"
              className="w-24 rounded-md border border-seal-200 bg-white px-2.5 py-1.5 font-mono text-xs font-semibold text-ink uppercase focus:border-seal-500 focus:outline-none shadow-2xs"
            />
          </div>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <span
              className="inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[11px] sm:text-xs font-semibold shadow-2xs whitespace-nowrap"
              style={{
            ...
            <span
              className="inline-flex items-center justify-center rounded-lg px-2.5 py-1 text-[11px] sm:text-xs font-bold text-white shadow-2xs whitespace-nowrap"
              style={{ backgroundColor: currentColor }}
            >
              Tombol
            </span>
